...
🗓️ **May** recorded the highest Total Sales of **₹53,150**, which was **125.02% higher** than **September**, the month with the lowest sales (**₹23,620**).  
...
- **Top Section:** KPIs with icons for better readability  
- **Left Panel:** Filter Section + Smart Insights Summary  
- **Design Style:** Clean alignment, consistent color palette  
- **UI Style:** Highlights, shadows, and rounded panels for a premium look  
...
<img width="1302" height="740" alt="Dashboard Screenshot" src="https://github.com/user-attachments/assets/78757df9-0c48-4880-bc12-284d7deb31a8" />
